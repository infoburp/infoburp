    ...
    sgvizler.ui = {
        ...
        params: [ 'query', 'endpoint', 'format', 'chart', 'width', 'height' ], // permissible URL parameters.
        ...
        displayUserInput: function (queryOpt) {
            ...
            $('input:radio[id=' + this.id.formFormat + '][value=' + queryOpt.endpoint_output + ']').attr('checked', true);
