//basic_persistence.js- stores some json (in this case, an infoburp layout)in a couchdb and updates it regularly.

// Creating graph database holding json that describes current graph layout
...
// This is for debug purposes. It makes it possible to develop interface without couchdb instance
if (COUCHDB)	{
    	// We save graph state every 5 seconds.
